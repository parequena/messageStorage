...
// Ctor.
InputManager::InputManager(RenderManager &renderer, MessageManager &storage) noexcept
...
// AddUser
void InputManager::addUser() const noexcept
{
...
// Send message.
void InputManager::sendMessage() const noexcept
{
...
void InputManager::receiveAllMessages() const noexcept
{
...
// Change lang.
void InputManager::changeLang() const noexcept
{
